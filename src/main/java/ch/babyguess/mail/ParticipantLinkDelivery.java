...
@Entity
@Table(name = "participant_link_delivery")
public class ParticipantLinkDelivery {
    ...
    protected ParticipantLinkDelivery() {
    }

    public ParticipantLinkDelivery(UUID id, Participant participant, Instant createdAt) {
        this.id = id;

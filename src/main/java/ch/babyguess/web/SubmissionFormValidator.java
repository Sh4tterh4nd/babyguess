...
@Component
public class SubmissionFormValidator {

    private final NameMatcher nameMatcher;

    public SubmissionFormValidator(NameMatcher nameMatcher) {
        this.nameMatcher = nameMatcher;
    }

    public void validate(SubmissionForm form, int maximumNameGuesses, Errors errors) {
